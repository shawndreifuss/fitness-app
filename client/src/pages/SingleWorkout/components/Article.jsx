...
const data = [
  ...
  const itemData = [
    {
      img: `${workout?.workout?.images?.[0]}`,
      featured: true,
      
    },
    {
      img: `${workout?.workout?.images?.[1]}`,
      featured: true,
    },
    {
      img: '/img/gif.png',
    ...
    const randomDescription = Benefits[Math.floor(Math.random() * Benefits.length)].description;
  return (
    ...
    <div className="w-full px-4 lg:w-8/12">
                ...
                <li>
                  ...
                  hips back as if you're trying to sit in Link chair. Ensure your
      ...
      <img src={item.img} alt={`workout image ${index + 1}`} className='w-full -mt-5'/>
                  ...
                  >
                    <div className="mx-auto max-w-[530px]">
                      ...
                      <p
                        className="mb-[18px] text-base italic leading-[28px] text-dark dark:text-white"
                      >
